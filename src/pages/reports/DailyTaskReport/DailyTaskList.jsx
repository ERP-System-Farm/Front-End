        ...
        <div className="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 p-4">
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3">
             <div className="lg:col-span-2 relative">
               <Search className="absolute right-3 top-3 h-4 w-4 text-slate-400 dark:text-slate-500" />
               <Input
                 placeholder="ابحث برقم التقرير، العملية..."
                 className="pl-3 pr-9 h-10 border-slate-200 dark:border-slate-700 font-bold bg-transparent"
             ...
             <div>
               <Select value={filters.operation || 'all'} onValueChange={(val) => setFilters({ ...filters, operation: val })}>
                 <SelectTrigger className="h-10 border-slate-200 dark:border-slate-700 font-bold bg-transparent" dir="rtl">
             ...
             <div>
               <Input
                 type="date"
                 className="h-10 border-slate-200 dark:border-slate-700 font-bold text-slate-500 dark:text-slate-400 bg-transparent"
             ...
             <div>
               <Button
                 ...
                 className="w-full h-10 border-rose-200 dark:border-rose-900 text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-900/30 hover:text-rose-700 font-bold bg-transparent"
               >
               ...
               <div className="flex flex-col divide-y divide-slate-100 dark:divide-slate-800">
                 {reports.map((report) => (
                   <Link
                     ...
                     className="group flex flex-col md:flex-row md:items-center gap-4 p-5 hover:bg-white dark:hover:bg-slate-800/50 transition-all hover:shadow-sm"
                   >
                     {/* Left: Status + Date */}
                     ...
                     <div className="flex-grow">
                        ...
                        <p className="text-sm font-bold text-slate-400 dark:text-slate-500 mt-1 flex items-center gap-1.5">
                     ...
                     {/* Right: Stats */}
                     <div className="flex-shrink-0 flex items-center gap-6 md:border-r md:border-slate-100 dark:md:border-slate-800 md:pr-6">
                        <div className="text-center">
                           <p className="text-xs font-bold text-slate-400 dark:text-slate-500 mb-0.5">المهندس</p>
                           <p className="text-sm font-black text-slate-700 dark:text-slate-300 flex items-center gap-1">
                              <User className="w-3.5 h-3.5 text-slate-400 dark:text-slate-500" />
                              {report.engineer_name}
                           </p>
                        </div>
                        <div className="text-center">
                           <p className="text-xs font-bold text-slate-400 dark:text-slate-500 mb-0.5">إجمالي العمالة</p>
                           <p className="text-lg font-black text-emerald-700 dark:text-emerald-400">
                              ...
                              <span className="text-xs text-emerald-400 dark:text-emerald-500/70 font-bold ml-1">عامل</span>
                           </p>
                        </div>
                        {report.status === 'submitted' && (
                           <div className="hidden md:flex items-center gap-1 text-amber-600 dark:text-amber-400 font-bold text-xs bg-amber-50 dark:bg-amber-900/20 px-2 py-1 rounded-lg">
